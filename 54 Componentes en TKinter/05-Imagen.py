...
def crear_componentes_tabulador4(tabulador):
    imagen = tk.PhotoImage(file=f"F:\practicas web\python\CursodePython\54 Componentes en TKinter\python-logo.png")
    def mostrar_titulo():
        messagebox.showinfo('Más info imagen', 'Nombre imagen: {imagen.cget("file")}')

...
if __name__=='__main__':
    print("Se esta iniciciando la ejecucion...")
    ...
    fin = time.time()
    print(f"El objetivo es {objetivo} Tiempo de búsqueda ingenua: {fin - inicio} segundos.")
    ...
    fin = time.time()
    print(f"El objetivo es {objetivo} Tiempo de búsqueda binaria: {fin - inicio} segundos.")